...
#include<stdlib.h>
#include<string.h>
// SIC alogorithim for encryption , decryption that Team 6 create (ziyad - radi - isma3eel)
...
char secret[27]="zyxuvwtsropqnmlijkhgfcdeba";// array of letter in decrypted form
...
char* deqrypt(char arr[] ) // same function but used for decryption
{
	...
	char secret[27]="zyxuvwtsropqnmlijkhgfcdeba";
